...
class Nutritonal extends StatefulWidget {
  Nutritonal({Key? key}) : super(key: key);

  @override
  State<Nutritonal> createState() => _NutritonalState();
}

class _NutritonalState extends State<Nutritonal> {
  @override
  void initState() {
    super.initState();
    check();
